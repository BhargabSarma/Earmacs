<aside class="w-64 bg-white shadow-lg flex flex-col justify-between">
    ...
    <div class="px-4 py-4 border-t space-y-2">
        <a href="#" class="block px-4 py-2 rounded hover:bg-indigo-100 text-gray-700 font-medium">Profile</a>
        <a href="#" class="block px-4 py-2 rounded hover:bg-red-100 text-red-600 font-medium">Logout</a>
    </div>
</aside>